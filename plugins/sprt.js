...
Asena.addCommand({pattern: 'dripsmemes', fromMe: false,dontAddCommandList: true}, (async (message, match) => {

    var r_text = new Array ();    
r_text[0] = "dripsmemes says i love you 😘";
r_text[1] = "dripsmemes says i love you 😘...";
r_text[2] = "dripsmemes says i love you 😘";
...
r_text[11] = "do you know who is my creator..? its none other than DripsMemes";
