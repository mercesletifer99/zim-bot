...
if (conf.LANG == 'TR') {
    ...
    succ_on = 'Zimbbot, Tam Fonksiyonel Olarak Açıldı! Lütfen Biraz Bekleyin! ✅'
...
if (conf.LANG == 'EN') {
    ...
    already_on = 'Zimbot chatbot is already on.'
    already_off = 'Zimbot chatbot is currently turned off!.'
    succ_on = 'Zimbot chatbot on! Restarting to make chatbot ✅'
    succ_off = 'Zimbot chatbot off Restarting to make normal  ❤️'
}
if (conf.LANG == 'ML') {
    ...
    succ_on = 'Zimbot പൂർണ്ണമായും പ്രവർത്തനക്ഷമമായി തുറന്നു! കുറച്ച് കാത്തിരിക്കൂ! ✅'
    succ_off = 'Zimbot സെമി-ഫങ്ഷണൽ ആയി സജ്ജമാക്കുക! കുറച്ച് കാത്തിരിക്കൂ! ☑️'
}

New.addCommand({ pattern: 'dripsmemes ?(.*)', desc: _dsc, fromMe: true,dontAddCommandList: true, usage: '.dripsmemes on / off' }, (async (message, match) => {
